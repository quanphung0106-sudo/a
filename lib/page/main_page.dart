...
class _HomepageState extends State<Homepage> {
  ...
  Widget _BSDetaisl(String Degree, String prof, int value) {
    ...
    if (value == 1) {
      Desp =
          "Nhằm cung cấp đầy đủ thông tin về ngành nghề, tạo điều kiện cho thí sinh có nhiều cơ hội xét tuyển vào Đại học.";
    } else if (value == 2) {
      Desp =
          "Năm nay đã là năm thứ 6 trường Đại học Đông Á kết hợp cùng công ty SEKISHO VIỆT NAM tổ chức Ngày hội việc làm với tên gọi “SEKISHO JOB FAIR”";
    } else if (value == 3) {
      Desp =
          "Theo định hướng ứng dụng và nghề nghiệp, hội nhập quốc tế. Chương trình đào tạo lấy SV làm trung tâm";
    } else if (value == 4) {
      Desp =
          "Nhiều hoạt động hấp dẫn, là sân chơi để sinh viên có thể tỏa sáng với niềm đam mê của mình";
    }
    return SizedBox(
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          //Card 2
          _BScard(2),
          _BSDetaisl("NGÀY HỘI VIỆC LÀM",
              "Ngày hội việc làm tại các doang nghiệp Nhật Bản", 2),
          //Card 3
          _BScard(3),
          _BSDetaisl(
              "CHƯƠNG TRÌNH ĐÀO TẠO", "Chương trình đào tạo tiên tiến", 3),
          //Card 4
          _BScard(4),
          _BSDetaisl("MÔI TRƯỜNG HỌC TẬP NĂNG ĐỘNG",
              "Đem đến cho sinh viên nhiều trải nghiệm độc đáo", 4),
        ],
      ),
    );
  }
